...
```
Execute "build_indexes.py" file. It contains the code for Contriever (MEGLIO NON AVVIARLO, CONTRIEVER E' DA RIVEDERE)
3. Execute "retrieval_models.py" file
3.1 (Optional) Execute "gemini.py" file, it needs your gemini api key
4. Execute "data_loader.py" file
5. Execute "train.py" file. Use the flag --h for help (change parameters)
```bash
python train.py --h
```
6. Execute "evaluation.py" file. Use the flag --h for help (change parameters)