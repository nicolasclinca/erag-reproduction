...
def process_source(in_path, out_path, max_records=0, buffer_size=2_000_000):
    """
...
# input_path = './Files/wikipedia_mini.jsonl'
# output_path = 'Files/Passages/wikipedia_passages.jsonl'
#
